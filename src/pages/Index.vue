<template>
  <Layout>
    ...
    <div class="list-of-users grid grid lg:grid-cols-5 grid-cols-2 lg:gap-4 gap-2 text-white">
      <div
      ...
      >
        ...
        <g-link :to="'/' + user.login"><div class="text-base text-center cursor-pointer hover:text-blue-400">{{ user.login }}</div></g-link>
      </div>
    </div>

    <div class="home-links text-center mt-4">
      <span class="mx-4 cursor-pointer hover:text-blue-400" @click="fetchUsers(users.pagination.first['since}'])"
